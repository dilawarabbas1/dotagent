...
def render_scope(project: Project) -> str:
    modules_md = ""
    ...
    return (
f"""<!-- generated by dotagent — do not edit. Re-render with `dotagent project add-module` (or any project state change) or `dotagent sync`. -->
...
{chr(10).join(f'- {x}' for x in project.out_of_scope) or '_(none)_'}

## Success criteria

{chr(10).join(f'- {x}' for x in project.success_criteria) or '_(none)_'}
